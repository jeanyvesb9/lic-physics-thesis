...
\begin{marginfigure}
    \centering
    \resizebox{0.9\linewidth}{!}{\input{common/Assets/Images/ttbar_diagram.tex}}
...
\begin{table}[t]
    \centering
    \small
    \input{Assets/Tables/CR+SR_definition.tex}
...
\begin{table*}[t]
    ...
    \input{Assets/Tables/CR+SR_yields.tex}
...
\begin{table}[t]
    \footnotesize
    \setlength{\tabcolsep}{1mm}
    \input{Assets/Tables/CR_qq-sign_yields.tex}
...
\begin{table}[bh!]
    \centering
    \small
    \input{Assets/Tables/ttbar_mu.tex}
