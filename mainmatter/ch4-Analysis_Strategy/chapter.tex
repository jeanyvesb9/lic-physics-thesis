...
Los últimos términos, \textit{JetWeight}, \textit{EleWeight} y \textit{MuoWeight}, corrigen diferencias en la eficiencia de procesamiento de cada objeto, entre simulaciones y datos\sidenote[][]{Para cada objeto incluido en el análisis
